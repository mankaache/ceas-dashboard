...
export function DeleteTrainingProgram({
  trainingProgram,
}: {
  ...
  const handleDelete = async () => {
    try {
      ...
      await deleteDoc(doc(firestore, "training-programs", trainingProgram.id));
  ...
  return (
    <Dialog>
      ...
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          <DialogTitle>
            <div className="text-2xl">Supprimer le programme de formation</div>
          </DialogTitle>
        </DialogHeader>
        <div className="flex items-center space-x-2">
          <p>Etes-vous sûr de vouloir supprimer cet programme de formation</p>
        </div>
